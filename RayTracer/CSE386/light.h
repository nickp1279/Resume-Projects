...
*/
struct DirectionalLight : public PositionalLight {
	dvec3 dir;				//!< Light vector (Field of view of the light)

	// Keep the position in there
	DirectionalLight(const dvec3& D, const color& lightColor = white)
		: PositionalLight(dvec3(0.0), lightColor), dir(glm::normalize(D)) {
